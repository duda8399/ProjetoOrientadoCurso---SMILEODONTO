	...
	<?php 
		...
		if ($acao == 'inserir') {
			...
			if(isset($_POST["nomeFuncionario"])) {
		        ...
		        $sexo        	 = $_POST["sexo"];
		        $foto       	 = $_FILES["fotoFuncionario"]['name'];
		        $bairro      	 = $_POST["bairro"];
		        $cep        	 = $_POST["cep"];
		        $numero      	 = $_POST["num"];
		        ...
		        if (!empty($foto)) {
			        ...
			        move_uploaded_file($_FILES['fotoFuncionario']['tmp_name'], $diretorio.$foto);

			        if(!$operacao_inserir) {
			            header("Location: listFuncionario.php?msg=5");
			    	}
		        }
			...
			header("Location: listFuncionario.php?msg=1");
			...
			if (isset($_GET['id'])) {
			    ...
			    if(!$remover_pessoa) {
			        header("Location: listFuncionario.php?msg=5");
			   		...
			   		header("Location: listFuncionario.php?msg=3");
			   	}
			}
			...
			if (!empty($_FILES["fotoFuncionario"]['tmp_name'])) {
		    ...
		    }else if (empty($_FILES["fotoFuncionario"]['tmp_name'])) {
			...
			header("Location: listFuncionario.php?msg=2");
