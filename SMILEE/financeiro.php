							...
							<div class="row">
								...
								<div class="col-lg-3">
									<div class="menu-lateral-financeiro">
										...
										<ul class="list-group">
											<li class="list-group-item active"><a href="financeiro.php">Todas as parcelas</a></li>
											<li class="list-group-item"><a href="financeiroPago.php">Parcelas pagas</a></li>
											<li class="list-group-item"><a href="financeiroPendente.php">Parcelas pendentes</a></li>
										</ul>
									</div>
								</div>
								<!--Fim do Menu Lateral-->
								...
								<div class="col-lg-9">
									<div class="conteudo">
										<div class="cabecalho-conteudo">
											...
											<h3 class="pl-1">Todas as parcelas</h3>
										</div>
