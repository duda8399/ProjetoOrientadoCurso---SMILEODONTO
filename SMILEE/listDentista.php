...
<html lang="pt-br">
	<head>
		...
		<script>
			$(document).ready(function() {
			    $('#listar-dentista').DataTable({
	        		"serverSide": true,
	                "ajax": {
			            "url": "list_dentista.php",
			            "type": "POST"
			        },
			        "language": {
							...
							<div class="row">
								...
								<div class="col-lg-9">
									<div class="conteudo">
										...
										<form method="POST" action="dentista_rotas.php">
											<div class="table-responsive pt-3 pl-2 pr-2 pb-2">
												<table id="listar-dentista" class="table table-striped" style="width:100%">
													<thead>
														<tr>
															<th>Nome</th>
											                <th>CRO</th>
    ...
    <script>
			$(document).on('click', '#excluir', function() {
				var cod = $(this).val();
				var href = 'dentista_controller.php?acao=remover&id='+ cod;
