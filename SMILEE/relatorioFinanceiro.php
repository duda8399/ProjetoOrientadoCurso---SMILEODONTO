<?php
	...
	if (isset($_POST['dataFI']) && isset($_POST['dataFF'])) {

		session_start();

		$_SESSION['dataFI'] = $_POST['dataFI'];
		$_SESSION['dataFF'] = $_POST['dataFF'];

	}else{
		session_start();

		$_SESSION['dataFI'] = '2019-01-01';
		$_SESSION['dataFF'] = '2019-12-31';
	}
	...
	<head>
	    ...
	    <script>
			$(document).ready(function() {
			    ...
			    $('#listar-financeiro').DataTable({
	        		"serverSide": true,
	                "ajax": {
			            "url": "list_relatorio_financeiro.php",
			            "type": "POST"
			        },
			        "language": {
							...
							<div class="row">
								...
								<div class="col-lg-3">
									<div class="menu-lateral2">
										...
										<div class="corpo-menu">
											<div class="m-3">
												<span>
													Resumo das parcelas cadastrados por período.
												</span>
											</div>
											<hr>
								...
								<div class="col-lg-9">
									<div class="conteudo">
										...
										<form method="POST" method="relatorioFinanceiro.php">
											<div class="form-row form">

												<div class="col-lg-6">
													<label>Pesquisa por período de vencimento</label>
													<div class="input-group mt-3">
														<div class="input-group-prepend">
														    <span class="input-group-text" style="background: #CCC;">De</span>
														</div>
														<input type="date" name="dataFI" class="form-control" value="<?php echo $_SESSION['dataFI']; ?>">

														<div class="input-group-prepend">
														    <span class="input-group-text" style="background: #CCC;">à</span>
														</div>
														<input type="date" name="dataFF" class="form-control" value="<?php echo $_SESSION['dataFF']; ?>">
													</div>
												</div>
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<div class="table-responsive pt-3 pl-2 pr-2">
													<table id="listar-financeiro" class="table table-striped" style="width:100%">
														<thead>
															<tr>
																<th>Valor Parcela</th>
																<th>Valor Pago</th>
