							...
							<div class="row">
								...
								<div class="col-lg-9">
									<div class="conteudo pb-3">
										...
										<form id="add-espec" method="POST" action="espec_controller.php?acao=atualizar">

										<div class="form-row">

											<?php foreach ($recuperar_espec as $espec) { ?>

											<input type="hidden" name="idEspecialidade" value="<?php echo $espec["idEspecialidade"]; ?>">
											...
											<div class="col-lg-6 pl-5">
												...
												<input type="text" name="especialidade" id="especialidade" placeholder="Digite o nome da especialidade" class="form-control" required="" value="<?php echo $espec["nomeEspecialidade"]; ?>">

												<label for="descricao" class="pt-3">Descrição:</label>
												<textarea class="form-control" name="descricao" id="descricao" rows="3"><?php echo $espec["descricao"]; ?></textarea>
