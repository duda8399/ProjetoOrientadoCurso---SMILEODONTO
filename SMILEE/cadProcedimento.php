							...
							<div class="row">
								...
								<div class="col-lg-9">
									<div class="conteudo pb-3">
										...
										<form id="add-proced" method="POST" action="proced_controller.php?acao=inserir">
										...
										<div class="form-row">
											...
											<div class="col-lg-6 pl-5">
												...
												<input type="text" name="procedimento" id="procedimento" placeholder="Digite o nome do procedimento" class="form-control" required="">
