							...
							<div class="row">
								...
								<div class="col-lg-9">
									<div class="conteudo">
										...
										<form id="add-imagem" method="POST" action="imagem_controller.php?acao=inserir" enctype="multipart/form-data">
											...
											<div class="form-row form1">
												...
												<div class="col-lg-3">
													<img src="img/img.png" id="img-file" width="130" height="129" class="img-file" style="margin-left: 10px;"><br>

													<div class="fileUp btn btn-outline-success">
				    									<span><i class="fas fa-upload text-black mr-3"></i>Enviar Foto</span>
				    									<input type="file" id="foto-upload" class="upload" name="foto" required="">
													</div>
												</div>
												...
												<div class="col-lg-9">
													...
													<input type="text" name="nome" id="nome" placeholder="Digite o nome da imagem" class="form-control" required="">

													<label for="dataCadastro" class="pt-3">Data do Cadastro:
														<span style="color: red;margin-left: 5px;">*</span>
													</label>
													<input type="text" name="dataCadastro" id="dataCadastro" class="form-control" value="<?php echo date('d/m/Y');?>" required >
