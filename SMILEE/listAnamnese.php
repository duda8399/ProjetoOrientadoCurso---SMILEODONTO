	...
	<head>
	    ...
	    <script>
			$(document).ready(function() {
			    $('#listar-anamnese').DataTable({
	        		"serverSide": true,
	                "ajax": {
			            "url": "list_preencherAnam.php",
			            "type": "POST"
			        },
			        "language": {
	...
	<body>
							...
							<div class="col-lg-9">
								<div class="conteudo">
									...
									<?php if(isset ($_GET['msg']) && $_GET['msg'] == 1){ ?>
										...
										<form method="POST" action="preencherAnam_rotas.php">
											<div class="btn-anam mt-3 mb-3 ml-3">
												<a href="preencherAnamnese.php" name="cadastrar" class="btn btn-cadastrar text-white">Nova Anamnese</a>
											</div>
											
											<div class="table-responsive pt-3 pl-2 pr-2 pb-2">
												<table id="listar-anamnese" class="table table-striped" style="width:100%">
													<thead>
														<tr>
															<th>Código Anamnese</th>
															<th>Questionário</th>
											                <th>Ações</th>
														</tr>
											        </thead>
		...
		<script>
			$(document).on('click', '#excluir', function() {
				var cod = $(this).val();
				var href = 'preencherAnam_controller.php?acao=remover&id='+ cod;
