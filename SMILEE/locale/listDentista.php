										...
										<table class="table">
											...
											<tbody>
												<tr class="conteudo-listagem">
													...
													<td>
														<a name="visualizar" href="visuDentista.php" class="btn btn-verde text-white">Visualizar</a>
														<a name="editar" href="editDentista.php" class="btn btn-editar text-white">Editar</a>
														<a href="apagarDentista.php" name="excluir" class="btn btn-excluir text-white">Excluir</a>
													</td>
												</tr>
											</tbody>
											<tbody>
												<tr class="conteudo-listagem2">
													<td>Dr. Danilo Ferreira</td>
													<td>98765</td>
													<td>(37) 9 9958-1386</td>
													<td>
														<a name="visualizar" href="visuDentista.php" class="btn btn-verde text-white">Visualizar</a>
