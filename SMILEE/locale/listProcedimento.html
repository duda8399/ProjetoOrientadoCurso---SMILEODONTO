					...
					<div class="col-lg-3">
						<div class="menu-lateral2">
							...
							<div class="corpo-menu">
								<div class="botao-proc">
									<a href="cadProcedimento.php" name="cadastrar" class="btn btn-cadastrar text-white">Adicionar Procedimento</a><br>
								</div>
								<hr>
										...
										<table class="table">
											...
											<tbody>
												<tr class="conteudo-listagem">
													<td>Aplicação de selante </td>
													<td>R$150,00</td>
													<td>Dentistica</td>
													<td>
														<a name="visualizar" href="visuProcedimento.php" class="btn btn-verde text-white">Visualizar</a>
														<a name="editar" href="editProcedimento.php" class="btn btn-editar text-white">Editar</a>
														<a href="apagarProcedimento.php" name="excluir" class="btn btn-excluir text-white">Excluir</a>
													</td>
												</tr>
											</tbody>
											<tbody>
												<tr class="conteudo-listagem2">
													<td>Extração de dente</td>
													<td>R$50,00</td>
													<td>Dentistica</td>
													<td>
														<a name="visualizar" href="visuProcedimento.php" class="btn btn-verde text-white">Visualizar</a>
