				...
				<div class="row">
					...
					<div class="col-lg-3">
						<div class="menu-lateral2">
							<div class="cabecalho">
								<h3>Cadastrar Convênios</h3>
							</div>
							<div class="corpo-menu">
								<div class="botao-cadastrar">
									<a href="cadConvenio.php" name="cadastrar" class="btn btn-cadastrar text-white">Adicionar Convênio</a><br>
								</div>
								<hr>
					...
					<div class="col-lg-9">
						<div class="conteudo">
							<div class="cabecalho-conteudo">
								<i class="fas fa-address-card icon-conteudo"></i>
								<h3>Convênios</h3>
							</div>
										...
										<table class="table">
											...
											<tbody>
												<tr class="conteudo-listagem">
													...
													<td>35570-000</td>
													<td>
														<a name="visualizar" href="visuConvenio.php" class="btn btn-verde text-white">Visualizar</a>
														<a name="editar" href="editConvenio.php" class="btn btn-editar text-white">Editar</a>
														<a href="apagarConvenio.php" name="excluir" class="btn btn-excluir text-white">Excluir</a>
													</td>
												</tr>
											</tbody>
											<tbody>
