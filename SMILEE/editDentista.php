						...
						<div class="row">
							...
							<div class="col-lg-9">
								<div class="conteudo-form">
									...
									<form id="add-dentista" method="POST" action="dentista_controller.php?acao=atualizar" enctype="multipart/form-data">
										<div class="form-row form">
											...
											<?php foreach ($recuperar_dentista as $dentista) { 
												$minhaUF = $dentista['ufConselho'];
												$minhaDE = $dentista['idEspecialidade']; ?>
											...
											<?php if ($foto != ""){ ?>
												...
												<div class="col-lg-6">
													<div class="upload">
														<img src="<?php echo "uploads/$id/$foto"; ?>" id="img-file" width="130" id="img-file" width="130" height="129" class="rounded-circle img-file">
													</div>
											...
											<?php }else{ ?>
												...
												<div class="col-lg-6">
													<div class="upload">
														<img src="img/add-foto.png" id="img-file" width="130" id="img-file" width="130" height="129" class="rounded-circle img-file">
													</div>
											...
											<div class="col-lg-6">
												<label for="nomePaciente">Nome do Dentista:
													<span style="color: red;margin-left: 5px;">*</span>
												</label>
												<input type="text" name="nomeDentista" id="nomeDentista" placeholder="Digite o nome completo" class="form-control" value="<?php echo $pessoa["nome"]; ?>">
										...
										<div class="form-row form">
											...
											<div class="col-lg-3">
												...
												<input type="text" name="CRO" id="CRO" class="form-control" required="" value="<?php echo $dentista["CRO"]; ?>">
											</div>
											...
											<div class="col-lg-3">
												...
												<input type="text" name="sigla" id="siglaConselho" class="form-control" value="<?php echo $dentista["siglaConselho"]; ?>">
											</div>
											...
											<div class="col-lg-3">
												...
												<?php foreach ($recuperar_estados as $uf) {
													$ufPrincipal = $uf['idUF'];

													if ($minhaUF == $ufPrincipal) { ?>

													<option value="<?php echo $uf["idUF"]; ?>" selected>
														<?php echo $uf["sigla"]; ?>	
													</option>
												<?php } else { ?>
											...
											<div class="col-lg-3">
												...
												<select name="especialidade" id="especialidade" class="form-control" required="">
													<?php foreach ($recuperar_espec as $espec) { 
														$principalDE = $espec['idEspecialidade'];

													if ($minhaDE == $principalDE) { ?>

													<option value="<?php echo $espec["idEspecialidade"]; ?>" selected>	
														<?php echo $espec["nomeEspecialidade"]; ?>
													</option>
