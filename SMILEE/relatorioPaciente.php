<?php
	...
	if (isset($_POST['dataI']) && isset($_POST['dataF'])) {
		...
		$_SESSION['dataI'] = $_POST['dataI'];
		$_SESSION['dataF'] = $_POST['dataF'];

	}else{
		session_start();

		$_SESSION['dataI'] = '2019-01-01';
		$_SESSION['dataF'] = '2019-12-31';
	}
											...
											<div class="form-row form">
												...
												<div class="col-lg-6">
													...
													<div class="input-group mt-3">
														...
														<input type="date" name="dataI" class="form-control" value="<?php echo $_SESSION['dataI']; ?>">

														<div class="input-group-prepend">
														    <span class="input-group-text" style="background: #CCC;">à</span>
														</div>
														<input type="date" name="dataF" class="form-control" value="<?php echo $_SESSION['dataF']; ?>">
													</div>
												</div>
