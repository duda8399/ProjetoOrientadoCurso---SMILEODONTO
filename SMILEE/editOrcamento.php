						...
						<div class="row">
							...
							<div class="col-lg-9">
								<div class="conteudo">
									...
									<form method="POST" action="orcamento_controller.php?acao=atualizar">
										...
										<div class="container-fluid">
				                        	<div class="form-row form1">
				                        		...
				                        		<div class="col-lg-6 pt-3">
				                        			<label for="dataE">Cancelado em:</label>
				                        		...
				                        		<div class="col-lg-6 pt-3">
				                        			...
				                        			<select id="situacao" name="situacao" class="form-control" required>
				                        				<option>Selecione..</option>
				                        				<?php foreach ($recuperar_situ as $situ) { 
				                        					$sitprincipal = $situ['idSituacaoTrat'];
				                        					if ($sitprincipal == $minhasit) { ?>

					                        					<option value="<?php echo $situ['idSituacaoTrat']; ?>" selected>
					                        						<?php echo $situ['situacao']; ?>
					                        					</option>
				                        					<?php }else { ?>
				                        						<option value="<?php echo $situ['idSituacaoTrat']; ?>">
					                        						<?php echo $situ['situacao']; ?>
					                        					</option>
					                        				<?php }} ?>
				                        			</select>
