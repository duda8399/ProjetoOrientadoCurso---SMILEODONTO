...
<html lang="pt-br">
									...
									<div class="conteudo">
										...
										<?php if(isset ($_GET['msg']) && $_GET['msg'] == 4){ ?>
											<div class="alert bg-danger alert-dismissible fade show text-white" role="alert">
											  ERRO - Esse procedimento está associado a um tratamento e/ou orçamento!
											  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
											    <span aria-hidden="true">&times;</span>
											  </button>
											</div>
										...
										<?php if(isset ($_GET['msg']) && $_GET['msg'] == 6){ ?>
											<div class="alert bg-danger alert-dismissible fade show text-white" role="alert">
											  ERRO - Por favor, tente mais tarde! Verifique se o procedimento não está associado a um tratamento.
											  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
											    <span aria-hidden="true">&times;</span>
											  </button>
											</div>
										...
										<form method="POST" action="proced_rotas.php">
											<div class="table-responsive pt-3 pl-2 pr-2 pb-2">
												<table id="listar-procedimento" class="table table-striped" style="width:100%">
													<thead>
														<tr>
											                <th>Procedimento</th>
											                <th>Valor</th>
    ...
    <script>
			$(document).on('click', '#excluir', function() {
				var cod = $(this).val();
				var href = 'proced_controller.php?acao=remover&id='+ cod;
