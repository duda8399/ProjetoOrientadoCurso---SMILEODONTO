						...
						<div class="row">
							...
							<div class="col-lg-9">
								<div class="conteudo-form">
									...
									<form id="add-funcionario" method="POST" action="funcionario_controller.php?acao=inserir" enctype="multipart/form-data">
										<div class="form-row form">
											...
											<div class="col-lg-6">
												...
												<input type="text" name="nomeFuncionario" id="nomeFuncionario" placeholder="Digite o nome completo" class="form-control">
